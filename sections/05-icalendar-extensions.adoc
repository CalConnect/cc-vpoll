...
+
[example]
in BASIC poll-mode, reaching the DTEND of the poll
...
NOTE: `RSVP=TRUE` MAY be used by the organizer to force the voter to
  reset their state and re-vote.

NOTE: `scheduleagentparam`, `scheduleforcesendparam` and
